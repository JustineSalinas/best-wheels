...
export default function CarDetailModal({ car, onClose }: CarDetailModalProps) {
  ...
  const messengerUrl = 'https://m.me/bestwheelscardisplay'
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-display font-700 text-sm uppercase tracking-wider py-3.5 rounded-xl transition-colors duration-200"
            >
